...
namespace PlugInHostNetFx481
{
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //HostOutput.PlugInResult? firstPlugin = ExecutePlugIn
        ...
        private static HostOutput.PlugInResult? ExecutePlugIn(string plugInName)
        {
            ...
            //Assembly plugin = Assembly.LoadFrom($@"..\..\..\..\PlugIn.NetFx.{netVersion}Rx{rxVersion}\bin\{Configuration}\net{netVersion}\PlugIn.NetFx.{netVersion}Rx{rxVersion}.dll");
